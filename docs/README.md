...
| [`01-product/glossary.md`](01-product/glossary.md) | Khái niệm này gọi là gì trong code, và hiện ra sao trên UI… | 🟡 một phần | xuất hiện một khái niệm nghiệp vụ mới trong code hoặc UI |
