...
Người chơi tower defense đến từ Kingdom Rush, Bloons, hoặc các bản Flash cũ. Từ họ dùng:
"cắm trụ", "lên đời trụ", "đợt này đông quá", "thủng rồi", "hết máu".

Họ **không** dùng: "DPS", "armor pierce", "meta build" — trừ khi đó là persona hardcore, và
người đó là **negative persona** ở đây: game này cố ý cho qua mọi bản đồ **không cần nâng
cấp**, nên người đi tìm chiều sâu build sẽ thất vọng, và đó là **đúng thiết kế**.

Kỳ vọng mạnh nhất: **thua vẫn phải được gì đó**. Người chơi tower defense hiện đại không
chấp nhận thua là về không.
