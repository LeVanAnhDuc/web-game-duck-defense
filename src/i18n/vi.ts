...
export const vi = {
  ...
  'title.lastMap': '{map} · kỷ lục đợt {wave} / {total}',
  ...
  'battle.confirmBuild': 'XÂY · {cost}',
  'battle.pickTowerFirst': 'Chọn một loại tháp',
  'battle.statDamage': 'Sát thương',
  'battle.statRange': 'Tầm bắn',
  'battle.statRate': 'Nhịp bắn',
  'battle.seconds': '{n} s',
  ...
  'battle.keyHint': 'Phím tắt: 1 2 3 chọn tháp · Esc bỏ chọn · Space gọi đợt khi chưa focus vào nút nào',
