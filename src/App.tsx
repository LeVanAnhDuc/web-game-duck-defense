...
import { BattleScreen } from '@/views/Battle';
import { MapSelectScreen } from '@/views/MapSelect';
import { ResultScreen, type ResultInfo } from '@/views/Result';
import { SettingsScreen } from '@/views/Settings';
import { TitleScreen } from '@/views/Title';
import { WorkshopScreen } from '@/views/Workshop';
